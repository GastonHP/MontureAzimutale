...
union()
{    
translate([0,0,-10]) pulleyGT2(20,22,10,pulleyH);
//translate([0,0,0]) cylinder(d=20,h=.5,$fn=422);
translate([0,0,pulleyH-1]) cylinder(d=20,h=1,$fn=422);
//translate([0,0,0.5]) cylinder(d1=20,d2=18,h=1,$fn=422);    
translate([0,0,pulleyH-2]) cylinder(d2=20,d1=18,h=1,$fn=422);             
}
translate([0,0,-21]) cylinder(d=8.15,h=222,$fn=128);
} 
...
HTD_3mm_pulley_dia = tooth_spacing (3-0.06,0.381);
