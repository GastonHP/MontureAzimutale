...
union()
{    
translate([0,0,-10]) pulleyGT2(16,17,10,pulleyH);
translate([0,0,0]) cylinder(d=11,h=.5,$fn=422);
translate([0,0,pulleyH-.5]) cylinder(d=11,h=.5,$fn=422);
translate([0,0,0.5]) cylinder(d1=11,d2=9,h=.5,$fn=422);    
translate([0,0,pulleyH-.5-.5]) cylinder(d2=11,d1=9,h=.5,$fn=422);             
}
translate([0,0,-21]) cylinder(d=5.15,h=222,$fn=128);
} 
